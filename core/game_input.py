...
# Pointer-sized unsigned integer used by WinAPI structures.
...
def _send_scan(scan: int, *, key_up: bool) -> None:
    ...
    event = INPUT(type=INPUT_KEYBOARD, data=INPUT_UNION(ki=keyboard_input))
...
def tap_key(key: str, hold_seconds: float = 0.075) -> None:
    """Send one short DirectInput-compatible key press and always release it."""
